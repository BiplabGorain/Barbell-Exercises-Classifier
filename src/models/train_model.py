...
# Todo : This is generating an error at the time of feature set 2
    ...
    new_scores = pd.DataFrame(
        {
            ...
            "accuracy": [
                performance_test_nn,
                performance_test_rf,
                # performance_test_knn,  # ? comment out due to the error
                performance_test_dt,
                performance_test_nb,
            ],
        }
...
X_train = participant_df[participant_df["participant"]
                         != "A"].drop("label", axis=1)
y_train = participant_df[participant_df["participant"] != "A"]["label"]

X_test = participant_df[participant_df["participant"]
                        == "A"].drop("label", axis=1)
...
X_train[feature_set_4].to_pickle("../../data/interim/X_train.pkl")
X_test[feature_set_4].to_pickle("../../data/interim/X_test.pkl")
