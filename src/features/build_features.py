...
df = pd.read_pickle("../../data/interim/02_outliers_removed_chauvent.pkl")
...
ax[1].plot(subset["acc_y_lowpass"].reset_index(
    drop=True), label="butterworth filter data")
